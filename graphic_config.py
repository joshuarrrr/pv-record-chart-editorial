...
AIRTABLE_ENDPOINTS = [
    {
        'name': 'cell-types',
        'url': 'https://api.airtable.com/v0/appdED0QPblKKMq68/Cell%20Types?maxRecords=100&view=Main%20View&api_key={}&sortField=Record%20lab%20date&sortDirection=desc'.format(AIRTABLE_KEY)
    }
]
